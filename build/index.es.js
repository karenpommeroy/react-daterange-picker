...
const styles$1 = (_) => createStyles$1({
    root: {
        width: 290
    },
    weekDaysContainer: {
...
const Month = props => {
    ...
    return (createElement(Paper, { square: true, elevation: 0, className: classes.root },
        createElement(Grid, { container: true },
            createElement(Header$1, { date: date, setDate: setDate, nextDisabled: !forward, prevDisabled: !back, onClickPrevious: () => handlers.onMonthNavigate(marker, NavigationAction.Previous), onClickNext: () => handlers.onMonthNavigate(marker, NavigationAction.Next), months: months }),
            createElement(Grid, { item: true, container: true, direction: "row", justify: "space-between", className: classes.weekDaysContainer }, weekDays.map(day => (createElement(Typography, { color: "textSecondary", key: day, variant: "caption" }, day)))),
            createElement(Grid, { item: true, container: true, direction: "column", justify: "space-between", className: classes.daysContainer }, chunks(getDaysInMonth$1(date), 7).map((week, idx) => (createElement(Grid, { key: idx, container: true, direction: "row", justify: "center" }, week.map(day => {
...
const DefinedRanges = props => {
    return (React__default.createElement(List, null, props.ranges.map((range, idx) => (React__default.createElement(ListItem, { button: true, key: idx, onClick: () => props.setRange(range) },
...
const styles$2 = (theme) => createStyles({
    header: {
        padding: "20px 70px"
    },
    headerItem: {
        ...
        React__default.createElement(Grid, { container: true, direction: "row", wrap: "nowrap" },
            React__default.createElement(Grid, null,
                React__default.createElement(Grid, { container: true, className: classes.header, alignItems: "center" },
                    ...
                    React__default.createElement(Grid, { item: true, className: classes.headerItem },
                        React__default.createElement(Typography, { variant: "subtitle1" }, endDate ? format(endDate, "MMMM dd, yyyy", { locale: translation === null || translation === void 0 ? void 0 : translation.locale }) : translationText === null || translationText === void 0 ? void 0 : translationText.endDate))),
...
const DateRangePickerImpl = (props) => {
    ...
    const [dateRange, setDateRange] = useState(Object.assign({}, initialDateRange));
