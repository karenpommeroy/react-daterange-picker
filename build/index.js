...
const styles = styles$3.createStyles({
    iconContainer: {
        padding: 5
    },
    icon: {
...
const Header = ({ date, classes, setDate, nextDisabled, prevDisabled, onClickNext, onClickPrevious, months = MONTHS, }) => {
    ...
    return (React__default.createElement(core.Grid, { container: true, justify: "space-between", alignItems: "center" },
        ...
        React__default.createElement(core.Grid, { item: true },
            React__default.createElement(core.Select, { value: getMonth(date), onChange: handleMonthChange, MenuProps: { disablePortal: true } }, months.map((month, idx) => (React__default.createElement(core.MenuItem, { key: month, value: idx }, month))))),
        React__default.createElement(core.Grid, { item: true },
            React__default.createElement(core.Select, { value: getYear(date), onChange: handleYearChange, MenuProps: { disablePortal: true } }, generateYears(date, 30).map(year => (React__default.createElement(core.MenuItem, { key: year, value: year }, year))))),
        React__default.createElement(core.Grid, { item: true, className: classes.iconContainer },
...
const useStyles = styles$3.makeStyles((theme) => styles$3.createStyles({
    leftBorderRadius: {
...
const styles$1 = (_) => core.createStyles({
    root: {
        width: 290
    },
    weekDaysContainer: {
...
const Month = props => {
    const { classes, helpers, handlers, value: date, dateRange, marker, setValue: setDate, minDate, maxDate, weekDays = WEEK_DAYS, months, } = props;
    ...
    return (React.createElement(core.Paper, { square: true, elevation: 0, className: classes.root },
        React.createElement(core.Grid, { container: true },
            React.createElement(Header$1, { date: date, setDate: setDate, nextDisabled: !forward, prevDisabled: !back, onClickPrevious: () => handlers.onMonthNavigate(marker, NavigationAction.Previous), onClickNext: () => handlers.onMonthNavigate(marker, NavigationAction.Next), months: months }),
            React.createElement(core.Grid, { item: true, container: true, direction: "row", justify: "space-between", className: classes.weekDaysContainer }, weekDays.map(day => (React.createElement(core.Typography, { color: "textSecondary", key: day, variant: "caption" }, day)))),
            React.createElement(core.Grid, { item: true, container: true, direction: "column", justify: "space-between", className: classes.daysContainer }, chunks(getDaysInMonth$1(date), 7).map((week, idx) => (React.createElement(core.Grid, { key: idx, container: true, direction: "row", justify: "center" }, week.map(day => {
...
const DefinedRanges = props => {
    return (React__default.createElement(core.List, null, props.ranges.map((range, idx) => (React__default.createElement(core.ListItem, { button: true, key: idx, onClick: () => props.setRange(range) },
...
const styles$2 = (theme) => styles$3.createStyles({
    header: {
        padding: "20px 70px"
    },
    headerItem: {
...
const Menu = props => {
    const { classes, ranges, dateRange, minDate, maxDate, firstMonth, setFirstMonth, secondMonth, setSecondMonth, setDateRange, helpers, handlers, translation, } = props;
    const translationText = Object.assign({
        ...
        React__default.createElement(core.Grid, { container: true, direction: "row", wrap: "nowrap" },
            React__default.createElement(core.Grid, null,
                ...
                React__default.createElement(core.Grid, { container: true, direction: "row", justify: "center", wrap: "nowrap" },
                    React__default.createElement(Month$1, Object.assign({}, commonProps, { value: firstMonth, setValue: setFirstMonth, navState: [true, canNavigateCloser], marker: MARKERS.FIRST_MONTH, weekDays: translationText === null || translationText === void 0 ? void 0 : translationText.weekDays, months: translationText === null || translationText === void 0 ? void 0 : translationText.months })),
                    React__default.createElement("div", { className: classes.divider }),
                    React__default.createElement(Month$1, Object.assign({}, commonProps, { value: secondMonth, setValue: setSecondMonth, navState: [canNavigateCloser, true], marker: MARKERS.SECOND_MONTH, weekDays: translationText === null || translationText === void 0 ? void 0 : translationText.weekDays, months: translationText === null || translationText === void 0 ? void 0 : translationText.months })))),
            React__default.createElement("div", { className: classes.divider }),
            React__default.createElement(core.Grid, null,
...
const DateRangePickerImpl = (props) => {
    ...
    const { open, onChange, initialDateRange, minDate, maxDate, definedRanges = defaultRanges, translation, } = props;
